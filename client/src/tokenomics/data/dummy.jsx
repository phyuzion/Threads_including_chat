...
const holdersGridImage = (props) => (
  <div className="image flex gap-4">
    ...
    <div>
      ...
      <p>{props.HolderEmail}</p>
    </div>
  </div>
);

const holderGridStatus = (props) => (
...
export const holdersData = [
  {
    HolderID: 1001,
    HolderName: 'Nirav Joshi',
    HolderEmail: 'nirav@gmail.com',
    HolderImage:
      avatar2,
    WalletAddr: 'Personal wallet',
    Status: 'Active',
    StatusBg: '#8BE78B',
    Weeks: '40',
    Budget: '$2.4k',
  ...
  },
  {
    ...
    HolderName: 'Sunil Joshi',
    HolderEmail: 'sunil@gmail.com',
    WalletAddr: 'MEXC',
    Status: 'Active',
    HolderImage:
      avatar3,
  ...
  },
  {
    ...
    HolderName: 'Andrew McDownland',
    HolderEmail: 'andrew@gmail.com',
    WalletAddr: 'Upbit',
    Status: 'Pending',
    HolderImage:
      avatar4,
  ...
  },
  {
    ...
    HolderName: 'Christopher Jamil',
    HolderEmail: 'jamil@gmail.com',
    WalletAddr: 'etc',
    Status: 'Completed',
    HolderImage:
      avatar,
...
export const semiPieData = [
  { x: 'Sales', y: 53, text: 'Sales: 14%' },
  { x: 'Eco', y: 56, text: 'Eco: 15%' },
  { x: 'Lock', y: 61, text: 'Lock: 16%' },
  { x: 'Wallet 1', y: 13, text: 'Wallet 1: 3%' },
  { x: 'Wallet 2', y: 79, text: 'Wallet 2: 21%' },
  { x: 'Wallet 3', y: 68, text: 'Wallet 3: 19%' },
  { x: 'Wallet 4', y: 48, text: 'Wallet 4: 12%' }
];
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Analyze the new requirements gathered from the holder.',
    Type: 'Story',
    Priority: 'Low',
    Tags: 'Analyze,Holder',
    Estimate: 3.5,
  ...
  },
  {
    ...
    Title: 'Task - 29003',
    Status: 'Open',
    Summary: 'Arrange a web meeting with the holder to get new requirements.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29005',
    Status: 'Review',
    Summary: 'Fix the issues reported by the holder.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Holder',
    Estimate: '3.5',
  ...
  },
  {
    ...
    Title: 'Task - 29011',
    Status: 'Validate',
    Summary: 'Validate the issues reported by the holder.',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Validation,Fix',
    Estimate: 1,
  ...
  },
  {
    ...
    Title: 'Task - 29027',
    Status: 'Open',
    Summary: 'Arrange web meeting with the holder to show editing demo.',
    Type: 'Others',
    Priority: 'High',
  ...
  },
  {
    ...
    Title: 'Task - 29029',
    Status: 'Review',
    Summary: 'Fix the editing issues reported by the holder.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Editing,Fix',
    Estimate: '3.5',
